...
void LogManager::output(const char *message, uint8_t outputs)
{
    ...
    {
        // Send message to BLE log task via queue
        String *msg = new String(message);
        xQueueSend(bleLogQueue, &msg, portMAX_DELAY);
    }
