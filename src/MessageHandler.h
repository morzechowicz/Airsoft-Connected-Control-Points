...
public:
    ...
    bool handleCommand(const Message& command,String msg,uint8_t rssi = 0, float snr = 0);
...
private:
    ...
    void handleTestMessage(const String& cmd, const String params[], int paramCount, uint8_t rssi, float snr);
