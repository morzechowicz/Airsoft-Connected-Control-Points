...
public:
    ...
    bool handleCommand(const Message& command,String msg,int16_t rssi = 0, float snr = 0);
...
private:
    ...
    void handleTestMessage(const String& cmd, const String params[], int paramCount, int16_t rssi, float snr);
    void handleDemoMessage(const String& cmd, const String params[], int paramCount);
    // // Helpers
