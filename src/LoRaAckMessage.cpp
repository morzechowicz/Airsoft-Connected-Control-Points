...
LoRaAckMessage::LoRaAckMessage(const String &message, int seqNum, int recipient) : msg(message), seqNum(seqNum),recipient(recipient), retryCount(0), interval(0), lastRetry(0), recived(false)
{
}
